...
write.csv(averages, file="C:/Users/Vanguard/Google Drive/Coursera/Assigment Getting and Cleaning Data/github/GettingAndCleaningData/result.txt", row.names=FALSE)
